...
class Countries(db.Model):
    ...
    flights_table_origin_country = db.relationship('Flights', backref='Countries')
...
class Flights(db.Model):
    ...
    destination_country_id = db.Column(db.String(50), nullable=False)  #TODO this should be a forien key column
